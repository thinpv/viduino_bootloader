...
{
	// // printf("sys_spi_flash_write_256 addr: 0x%08lX, len: %d\r\n", addr, len);
	uint8_t tx[4];
...
{
	// // printf("sys_spi_flash_write addr: 0x%08lX, len: %d\r\n", addr, len);
...
{
	// // printf("sys_spi_flash_erase_4k addr: 0x%08lX\r\n", addr);
	uint8_t tx[4];
...
{
	// // printf("sys_spi_flash_erase_32k addr: 0x%08lX\r\n", addr);
	uint8_t tx[4];
...
{
	// // printf("sys_spi_flash_erase_64k addr: 0x%08lX\r\n", addr);
	uint8_t tx[4];
