...
uint32_t arm32_read_p15_c0(uint32_t ld)
{
	...
	}else
	{
		...
		// }	
	__asm__ __volatile__("mrc p15, 0, %0, c0, c0, 1" : "=r" (value));
	}
	return value;
}
/*
...
// 	// }		
// 	__asm__ __volatile__("mcr p15, 0, %0, c7, c10, 4" : : "r" (value));	
// 	__asm__ __volatile__("mcr p15, 0, %0, c8, c6, 0" : : "r" (value));	
// 	__asm__ __volatile__("mcr p15, 0, %0, c8, c5, 0" : : "r" (value));	
// }
